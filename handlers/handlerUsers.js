...
const createUser = async (ci,username, pass, champion, subchampion) => {
    let con = null;
    try{
...
const modifyPassword = async (ci, password) => {
    try{
...
module.exports = {createUser, modifyPassword, signin };